...
subtitle: "Research on COVID-19 Vccination"
...
knitr::include_graphics("figs/daily-cases-covid-region.png")
```
...
## Top 5 countries with the highest daily positive cases ralate to COVID-19
...
## Top 5 countries with the highest daily death number ralate to COVID-19

```{r out.width = '100%', echo = FALSE, fig.align="center"}
knitr::include_graphics("figs/daily-deaths.png")
```
...
```{r out.width = '100%', echo = FALSE, fig.align="center"}
knitr::include_graphics("figs/fully-vaccinated.png")
```
